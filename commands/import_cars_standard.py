                    ...
                    try:
                        ...
                        insert_query = """
                            INSERT INTO cars_standard (
                                ...
                                brand_raw, brand_raw2, model_group_raw, model_raw,
                                variant_raw, variant_raw2, variant_raw3, variant_raw4
                        ...
                        cur.execute(insert_query, (
                            ...
                            parse_csv_value(row.get('brand_raw')),
                            parse_csv_value(row.get('brand_raw2')),
                    ...
                    try:
                        ...
                        upsert_query = """
                            ...
                            DO UPDATE SET
                                ...
                                brand_raw2 = EXCLUDED.brand_raw2,
